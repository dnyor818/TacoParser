...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            double distance = 0; // diff between loc 1 and two
            ...
            Console.WriteLine($"{location1.Name} is furthest from {location2.Name} with a distance of {distance}");
